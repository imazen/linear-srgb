...
// variants generated by `#[magetypes(rite, define(f32x16), ...)]`.
//
// `f32x16` polyfills natively per tier: 1 op on V4 (AVX-512), 2× f32x8 on V3.
// V3 + V4 only — NEON/WASM/scalar slice dispatchers go through
...
mod tests {
    ...
    fn simd_power_result_clamped_near_one() {
        ...
        // (mt_srgb_to_linear / mt_linear_to_srgb) must apply .min(one)
