...
pub fn srgb_to_linear_v4(token: Server64, srgb: [f32; 16]) -> [f32; 16] {
    ...
    let u = srgb.mul_add(
        mt_f32x16::splat(token, S2L_INV_HW),
        mt_f32x16::splat(token, S2L_BIAS),
    );
    let u2 = u * u;
    let u4 = u2 * u2;
    let u_8 = u4 * u4;
    let p01 = mt_f32x16::splat(token, S2L_C1).mul_add(u, mt_f32x16::splat(token, S2L_C0));
    let p23 = mt_f32x16::splat(token, S2L_C3).mul_add(u, mt_f32x16::splat(token, S2L_C2));
    let p45 = mt_f32x16::splat(token, S2L_C5).mul_add(u, mt_f32x16::splat(token, S2L_C4));
    let p67 = mt_f32x16::splat(token, S2L_C7).mul_add(u, mt_f32x16::splat(token, S2L_C6));
    let p89 = mt_f32x16::splat(token, S2L_C9).mul_add(u, mt_f32x16::splat(token, S2L_C8));
    let pab = mt_f32x16::splat(token, S2L_C11).mul_add(u, mt_f32x16::splat(token, S2L_C10));
...
pub fn linear_to_srgb_v4(token: Server64, linear: [f32; 16]) -> [f32; 16] {
    ...
    let s = linear.sqrt();
    let u = s.mul_add(
        mt_f32x16::splat(token, L2S_INV_HW),
        mt_f32x16::splat(token, L2S_BIAS),
    );
    let u2 = u * u;
    let u4 = u2 * u2;
    let u_8 = u4 * u4;
    let p01 = mt_f32x16::splat(token, L2S_C1).mul_add(u, mt_f32x16::splat(token, L2S_C0));
    let p23 = mt_f32x16::splat(token, L2S_C3).mul_add(u, mt_f32x16::splat(token, L2S_C2));
    let p45 = mt_f32x16::splat(token, L2S_C5).mul_add(u, mt_f32x16::splat(token, L2S_C4));
    let p67 = mt_f32x16::splat(token, L2S_C7).mul_add(u, mt_f32x16::splat(token, L2S_C6));
    let p89 = mt_f32x16::splat(token, L2S_C9).mul_add(u, mt_f32x16::splat(token, L2S_C8));
    let pab = mt_f32x16::splat(token, L2S_C11).mul_add(u, mt_f32x16::splat(token, L2S_C10));
    let pcd = mt_f32x16::splat(token, L2S_C13).mul_add(u, mt_f32x16::splat(token, L2S_C12));
    let pef = mt_f32x16::splat(token, L2S_C15).mul_add(u, mt_f32x16::splat(token, L2S_C14));
    let p0123 = p23.mul_add(u2, p01);
    let p4567 = p67.mul_add(u2, p45);
